    ...
    global.renderPDF = function(content, pdfName="content", format="a4", onSuccess){
        ...
        function renderPages(imgData){
            ...
            if(contentHeight < pageHeight){
                ...
                pdf.addImage(imgData, 'PNG', 0, 0,pdfFormat[format][0],pdfFormat[format][1]/pageHeight*contentHeight);
                ...
                function addPage(i, onFinished){
                    ...
                    html2canvas(page, {
                        ...
                        onrendered: function(canvas) {
                            ...
                            pdf.addImage(pageData, 'PNG', 0, 0,pdfFormat[format][0],pdfFormat[format][1]);
                ...
                addPage(index, function(){
                    ...
                    html2canvas(page, {
                        ...
                        onrendered: function(canvas) {
                            ...
                            pdf = pdf.addPage();
                            pdf.addImage(pageData, 'PNG', 0, 0,pdfFormat[format][0], pdfFormat[format][1]/pageHeight*lastPageHeight);
