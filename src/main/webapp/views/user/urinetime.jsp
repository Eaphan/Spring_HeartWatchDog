            ...
            <fieldset>
              ...
              <div>
                <div class="col-sm-offset-2 col-sm-6">
                  ...
                  <button type="button" onclick="javascript:window.location.href=('urineList');" class="btn btn-primary">查询所有记录</button>
                </div>
              </div>
            </fieldset>
          </form>
...
//        在这个地方要注意不能写javascript格式，第二不能用.text()获取数据
            var url="urineSelectByTime?startdate="+a+"&enddate="+b;
