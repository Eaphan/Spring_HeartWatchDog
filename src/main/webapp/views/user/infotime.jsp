    ...
    <div class="container body">
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          <!-- top tiles -->
          <h1 class="sub-header">请选择日期范围查询心电检测记录</h1>
          <br>
            ...
            <fieldset>
              ...
              <div>
                <div class="col-sm-offset-2 col-sm-6">
                  ...
                  <button type="button" onclick="javascript:window.location.href=('infoList');" class="btn btn-primary">查询所有记录</button>
                </div>
              </div>
            </fieldset>
          </form>
...
//        在这个地方要注意不能写javascript格式，第二不能用.text()获取数据
            var url="infoSelectByTime?startdate="+a+"&enddate="+b;
